...
,p_last_upd_yyyymmddhh24miss=>'20180417114610'
);
...
'            p_body       => ''Для смены пароля перейдите по адресу http://online.kapremont68.ru:8080/ords/f?p=lk:reset:::::id:''||new_guid,',
'            p_body_html  => ''<a href="http://online.kapremont68.ru:8080/ords/f?p=lk:reset:::::id:''||new_guid||''">Сменить пароль для online.kapremont68.ru</a>''',
'    );',
