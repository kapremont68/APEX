...
,p_last_upd_yyyymmddhh24miss=>'20180417114959'
);
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(12015345012662901)
,p_name=>'P7_EMAIL'
,p_is_required=>true
,p_item_sequence=>10
...
'        P_EMAIL => :P7_EMAIL);',
'    new_guid := #OWNER#.LK_AUTH.add_email_guid(:P7_EMAIL);',
'    apex_mail.send(',
'            p_to         => :P7_EMAIL,',
'            p_from       => ''online@kapremont68.ru'', ',
'            p_subj       => ''online.kapremont68.ru - Подтверждение регистрации'',',
'            p_body       => ''Для подтвеждения регистрации перейдите по адресу http://online.kapremont68.ru:8080/ords/f?p=lk:confirm:::::id:''||new_guid,',
'            p_body_html  => ''<a href="http://online.kapremont68.ru:8080/ords/f?p=lk:confirm:::::id:''||new_guid||''">Подтвердить регистрацию на online.kapremont68.ru</a>''',
'    );',
